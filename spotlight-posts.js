...
window.SPOTLIGHT_POSTS = [
     ...
     --------------------------------------------------------------- */
  {
    ...
    body: [
      { en: "North Alabama Korean School has opened Korean Lab, a free online vocabulary tool built for our students and families, on the school website. It starts with 295 picture cards and will grow toward 1,500, and it opens directly on a phone, tablet, or computer with no app to download and no cost.",
        ko: "북알라바마한국학교가 학생과 학부모님을 위해 만든 무료 온라인 단어 학습 도구 「한국어 실험실」을 학교 홈페이지에 공개했습니다. 지금은 그림 카드 295장으로 시작해 1,500장까지 늘려 갈 계획이며, 앱을 내려받거나 비용을 낼 필요 없이 휴대폰과 태블릿, 컴퓨터에서 바로 열립니다." },
      ...
      { en: "Korean Lab was not adapted from a program built elsewhere; it was made for this school from the beginning. That is why the forms that are not suitable for children to actually use were not left as they were: 선생 became 선생님, and 안녕 became 안녕하세요 — so that a child can say what they have learned to an adult exactly as they learned it.",
        ko: "한국어 실험실은 다른 곳의 학습 프로그램을 가져다 쓴 것이 아니라 우리 학교를 위해 처음부터 만든 것입니다. 그래서 아이들이 실제로 쓰기에 알맞지 않은 형태도 그대로 두지 않았습니다. 「선생」은 「선생님」으로, 「안녕」은 「안녕하세요」로 고쳐 담았습니다. 아이들이 배운 말을 그대로 어른들께 쓸 수 있도록 하기 위해서입니다." },
      ...
      { en: "Getting started is simple. Open [northalabamakoreanschool.org/learn-korean](https://northalabamakoreanschool.org/learn-korean/) on a phone and the first card appears immediately. In Safari on iPhone or Chrome on Android, tap the Share button and choose \"Add to Home Screen,\" and an icon appears just like an app so it opens in one tap from then on. To save learning history and medals, please sign in with a Google account; without signing in, the record stays only on that one device.",
        ko: "사용법은 간단합니다. 휴대폰에서 [northalabamakoreanschool.org/learn-korean](https://northalabamakoreanschool.org/learn-korean/) 으로 들어가면 바로 첫 카드가 나옵니다. 아이폰은 사파리에서, 안드로이드는 크롬에서 공유 버튼을 누른 뒤 「홈 화면에 추가」를 선택하면 앱처럼 아이콘이 생겨 다음부터는 한 번에 열 수 있습니다. 학습 기록과 메달을 저장하려면 구글 계정으로 로그인해 주시기 바랍니다. 로그인하지 않으면 기록이 그 기기에만 남습니다." },
      ...
      { en: "We hope our children meet Korean naturally, through pictures and sound, rather than memorizing it as a burden. Sit down with your child tonight and turn the first card together. Korean Lab is open now at [northalabamakoreanschool.org/learn-korean](https://northalabamakoreanschool.org/learn-korean/).",
        ko: "아이들이 한국어를 어렵게 외우는 것이 아니라 그림과 소리로 자연스럽게 만나기를 바랍니다. 오늘 저녁 아이와 함께 첫 카드를 넘겨 보시기 바랍니다. 한국어 실험실은 [northalabamakoreanschool.org/learn-korean](https://northalabamakoreanschool.org/learn-korean/) 에서 지금 바로 열립니다." }
    ]
  },
